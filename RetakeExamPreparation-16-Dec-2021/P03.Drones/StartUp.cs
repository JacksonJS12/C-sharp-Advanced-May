...
namespace Drones
{
    public class StartUp
    {
        ...
        {
            Airfield airfield1 = new Airfield("Heathrow1", 10, 10.5);
            Drone drone1 = new Drone("CW4", "Cheerwing", 8);
            Drone drone2 = new Drone("EVO2", "Autel", 10);

            Console.WriteLine(airfield1.AddDrone(drone1));

            Console.WriteLine(airfield1.AddDrone(drone2));

            airfield1.RemoveDrone("EVO2");
            Console.WriteLine(airfield1.RemoveDrone("EVO2"));

            Console.WriteLine(airfield1.Report());
